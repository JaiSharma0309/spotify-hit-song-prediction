...
DATA_PATH = ROOT_DIR / "data" / "spotify_enriched.csv"
...
if __name__ == "__main__":
    ...
    for col in key_numeric:
        ...
        fig.tight_layout()
        fig.savefig(FIGURES_DIR / f"violin_{col}.png", dpi=150)
        plt.close(fig)
    ...
    fig.tight_layout()
    fig.savefig(FIGURES_DIR / "perm_importance_svm.png", dpi=150)
    plt.close(fig)
    ...
    fig.tight_layout()
    fig.savefig(FIGURES_DIR / "roc_logreg_vs_svm.png", dpi=150)
    plt.close(fig)
